    ...
    >
      <div>
        ...
        <div className="flex items-start justify-between gap-3 pb-3 border-b border-hud-border/70">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-hud-card border border-hud-border text-[11px] font-mono">
            {isInconclusive ? (
              <>
          ...
          <div className="mt-3 space-y-1.5">
            ...
            <div className="space-y-1.5 max-h-36 overflow-y-auto pr-1">
              {discreteComponents.map((comp, idx) => (
                <div
                  key={idx}
                  className="px-3 py-2 rounded-xl bg-hud-card/70 border border-hud-border flex items-center justify-between text-xs font-mono"
                >
