    ...
    <div className="p-6 rounded-3xl bg-hud-surface border border-hud-border shadow-xl">
      <div className="flex flex-wrap items-center justify-between gap-2 pb-4 border-b border-hud-border/70 mb-6">
        <div className="flex items-center gap-3 min-w-0">
          ...
          />
          <h3 className="text-sm font-bold text-white font-telemetry uppercase tracking-wider truncate">
      ...
      {displayDetail && (
        <div className="mt-4 p-3.5 rounded-xl bg-hud-bg/80 border border-hud-border text-xs font-mono text-slate-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <span className="shrink-0 text-slate-400 font-bold uppercase tracking-wider text-[10px]">
            Active Pipeline Telemetry:
          </span>
          <div className="text-cyan-300 font-medium flex-1 text-left sm:text-right">
            <MarkdownText text={displayDetail} />
          </div>
        </div>
      )}
    </div>
